<?php
if ( ! function_exists( 'aside_meta_content' ) ) :

		function aside_meta_content()
		{
		...
		<?php }  } endif;
if ( ! function_exists( 'post_meta_content' ) ) :
function post_meta_content()
{ 
			$appointment_options=theme_setup_data();
			$news_setting = wp_parse_args(  get_option( 'appointment_options', array() ), $appointment_options );
...
function post_thumbnail($preset,$class){
...
if(!function_exists( 'post_layout_class' )) :
function post_layout_class(){
